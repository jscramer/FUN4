<template>
    <div class="request">
        <div class="hero is-primary">
            <div class="hero-body">
                <div class="container">
                    <h1 class="title is-size-1">Coffee Types</h1>
                </div>
            </div>
        </div>
        <form class="vue-form" @submit.prevent="processForm">
        <div class="container">
            <p class="org-description is-size-4">Remove a new coffee type</p>
...
<script>
    ...
    export default {
        ...
        methods:{
            processForm(){
                axios.delete("http://localhost:8080/coffee/delete/"+this.coffeeChoice);
                this.$router.go('/');
            }
        },
        mounted() {
